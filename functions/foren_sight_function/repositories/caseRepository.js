...
class CaseRepository extends BaseRepository {
  ...
  async findCase(searchParams) {
    ...
    caseRecord.CaseMaster = cmRecord;
    caseRecord.Court = courtRecord;
    caseRecord.Unit = unitRecord;
    caseRecord.Employee = empRecord;
    caseRecord.CaseStatusMaster = statusRecord;
